...
export const TileWrapper: React.FC<WrapperProps> = ({
  ...
  return (
    <TileContext.Provider value={{ numOfPages, currentPage }}>
      <div
        ref={refContainer}
        className="relative bg-gray text-white"
        style={{
...
export const TileBackground: React.FC<PropsChildren> = ({ children }) => (
  <div className="absolute h-full w-full">{children}</div>
);

export const TileContent: React.FC<PropsChildren> = ({ children }) => (
